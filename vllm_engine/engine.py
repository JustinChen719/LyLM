...
from core.configs import EngineConfig


class Engine:
    def __init__(self, engine_config: EngineConfig):
        print("Init LLM Engine:", engine_config.engine_args.model)
    ...
    async def generate(self, request_id: str, history: list, max_tokens: int, temperature: float, top_p: float) \
